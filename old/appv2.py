...
import pandas as pd
from old.AgentEMOv3 import process_user_diary
...
@app.route("/")
def index():
    return render_template("index.html", analysis=["待更新"] * 3, recommendations=["待更新"] * 3)
